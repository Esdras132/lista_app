...
class ItemsListaPersonalizadaPage extends StatefulWidget {
  ...
  const ItemsListaPersonalizadaPage({super.key, required this.model});

  @override
  State<ItemsListaPersonalizadaPage> createState() => _ItemsListaPersonalizadaPageState();
}

class _ItemsListaPersonalizadaPageState extends State<ItemsListaPersonalizadaPage> {
